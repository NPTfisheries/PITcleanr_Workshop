...
author: Kevin See, Ryan Kinzer, Mike Ackerman
institute: "WDFW <br/> Department of Fish Science <br/> <br/> Nez Perce Tribe <br/> Department of Fisheries Resources Management"
...
output:
  xaringan::moon_reader:
    ...
    # css: [default, rladies]
    css: ["default", "metropolis-fonts", "tamu_custom.css"]
    # lib_dir: libs
    nature:
      ratio: '16:9'
...
include_graphics('images/BiomarkFeatureSalmon.jpg', dpi = NA)
```
</center>
...
include_graphics('images/PITarray_flow.jpg', dpi = NA)
```
</center>
...
include_graphics('images/snake_site_map.png', dpi = NA)
```
...
include_graphics(paste0('images/', 
                        root_site, '_site_map.png'), dpi = NA)
```
]
...
???
`auto_keep_obs` are the default options
...
include_graphics('images/website_screenshot.png', dpi = NA)
```
</center>
...
<center>
```{r, echo = F, out.width='75%'}
include_graphics('images/vignettes_screenshot.png', dpi = NA)
```
</center>
